...
<script type="text/javascript"
	src="${ctx }/js/ms/advrelease/init_add_winadvadd.js"></script>
</head>
<body>
	<table border="0" width="100%" cellspacing="0" cellpadding="4">

		<tr bgcolor="#f4f4f4">
			<td height="22" colspan="7"><input id="tyId" name="tyId"
				value="${tyId }" type="hidden" /> <b>查询条件</b>
			</td>
		</tr>
		<tr>
			...
			<td width="25%"><select id="code2" name="code2"
			...
			<td align="right"><a id="btnQuery1" href="javascript:void(0);"
				...
				<a id="btnQuery2" href="javascript:void(0);"
