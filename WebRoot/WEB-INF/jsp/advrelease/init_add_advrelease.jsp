...
<script type="text/javascript"
	src="${ctx}/js/ms/advrelease/init_add_advrelease.js"></script>
</head>
<body>
						...
						<table class="work-table" id="advinfo">
							...
							<tr>
								...
								<td align="center"><input type="hidden" name="advId" /> <input
									...
									readonly="readonly" onclick="selectAdv();" /></td>
						...
						<table class="work-table" id="advreleaseinfo">
							<tr>
								<td width="3%">序号<a href="javascript:advreleaseAdd();"><img
										id="add" alt="新增" src="${ctx}/images/add.png" /> </a></td>
