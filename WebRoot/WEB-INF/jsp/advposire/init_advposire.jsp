...
<script type="text/javascript"
	src="${ctx }/js/ms/advposire/init_advposire.js"></script>
</head>
<body>
	<table border="0" width="100%" cellspacing="0" cellpadding="4">
		...
		<tr>
			...
			<td width="8%" height="22" align="right">开始竞拍时间：</td>
			...
			<td width="8%" height="22" align="right">发布状态：</td>
			<td width="13%"><select id="advplaceState" name="advplaceState"
				style="height: 22px">
					<option value="">--全部--</option>
					<option value="0">发布中</option>
					<option value="-1">发布结束</option>
