...
<script type="text/javascript"
	src="${ctx}/js/ms/advposire/init_modify_advposire.js"></script>
</head>
<body>
	<form id="advplacereleaseForm" id="advplacereleaseForm" method="post">
		<input type="hidden" id="ctx1" value="${ctx }" /> <input
			type="hidden" id="advplaceId" value="${advplaceRelease.advplaceId }" />
		<table class="commonTab" border="1" style="border-color:#e3e8f9;">
						...
						<table class="work-table" id="advinfo">
							...
							<tr>
								...
								<td align="center"><input type="hidden" name="advId"
									value="${advplaceRelease.advAttribute.advId}" /> <input
									type="text" name="regionName" style="height:20px;padding:0px;"
									onclick="selectAdv();"
									value="${advplaceRelease.advAttribute.regionName}" /></td>
								<td align="center"><input type="text"
									name="detailedAddress" style="height:20px;padding:0px;"
									value="${advplaceRelease.advAttribute.advArea}${advplaceRelease.advAttribute.advPage}${advplaceRelease.advAttribute.advPosition}"
			...
			<tr>
				...
				<td><input type="text" id="startingPrice" name="startingPrice"
					...
					value="${advplaceRelease.startingPrice}" />
				</td>
				<td height="22">加价幅度:</td>
				<td><input type="text" id="increase" name="increase"
					style="width: 65%" class="easyui-numberbox"
					data-options="min:0,max:99999,precision:0"
					value="${advplaceRelease.increase}" />
				</td>
			</tr>
			<tr>
				<td height="22">评估价:</td>
			...
			<tr>
				...
				<td colspan="4"><textarea name="biddingNotice"
						id="biddingNotice"
						style="width:100%;height:300px;visibility:hidden;">${advplaceRelease.biddingNotice}</textarea>
				</td>
			</tr>
			<tr>
				...
				<td colspan="4"><textarea name="biddingBulletin"
						id="biddingBulletin"
						style="width:100%;height:300px;visibility:hidden;">${advplaceRelease.biddingBulletin}</textarea>
				</td>
			</tr>
		</table>
	</form>
