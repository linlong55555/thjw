		...
		<table class="commonTab" border="1" style="border-color:#e3e8f9;">
			...
			<tr>
				...
				<td rowspan="6"  id="imgrows"><input id="basepath"
					...
					id="imgName" src="" width="100%" height="220px" alt="广告位无图片" /></td>
			</tr>
			<tr>
				<td height="22" align="right" style="min-width: 100px">*体验馆/频道:</td>
				<td align="left"><input type="text" id="advArea"
					name="advArea" style="width: 90%" /></td>
				<td height="22" align="right" style="min-width: 140px">*体验馆内区域/页面地址:</td>
				<td align="left"><input type="text" id="advPage"
					name="advPage" style="width: 90%" /></td>
			</tr>
			<tr id="showOrHide">
			...
			<tr>
				...
				<td><select id="advStatus" name="advStatus" style="width: 90%">
