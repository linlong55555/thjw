...
function confirmregionC() {
	var regionC = $("#regionC").val();
	for ( var i = 0; i < $("#regionCode")[0].options.length; i++) {
		if (regionC == $("#regionCode")[0].options[i].value.split("-")[0]) {
			$("#regionCode")[0].options[i].selected = true;
		}
	}
}
